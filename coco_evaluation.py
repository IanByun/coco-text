...
def printDetailedResults(c_text, detection_results, transcription_results, name):
    ...
    ileg_mp = c_text.getAnnIds(imgIds=[], catIds=[('legibility', 'illegible'), ('class', 'machine printed')],
                               areaRng=[])
    ...
    fscore = "%.2f" % (2 * t_recall_new * t_precision_new / (t_recall_new + t_precision_new)) if (
                                                                                                             t_recall_new + t_precision_new) > 0 else 0
    ...
    print()
    print("{} & {} & {} & {} & {} & {} & {} & {} & {} & {} & {}".format(lm, lh, ilm, ilh, total, precision, f_score,
                                                                        transAcc, recall_new, precision_new, fscore))
    print("")
